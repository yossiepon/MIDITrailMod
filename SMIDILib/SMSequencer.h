...
public:
	...
	//演奏位置を曲の先頭に戻す（停止中のみ。GetCurrentTickTime 等が 0 を返すようになる）
	int Rewind();

	//���݂̉��tTick���ʒu���擾�iDX11�F���b�Z�[�W�����̃|�[�����O�p�j
	unsigned long GetCurrentTickTime();

	//���݂̉��t����(msec)���擾�iDX11�Fripple�̕��ʐ��擾�p�j
	unsigned long GetCurrentPlayTimeMSec();
