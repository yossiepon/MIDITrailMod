...
//******************************************************************************
// Vertex buffer creation (Rain coordinates, same as Rain11)
//******************************************************************************
int MTPianoKeyboardRoll11::_CreateVertexOfKeyboard(
		ID3D11Device* pDevice,
		ID3D11DeviceContext* pContext
	)
{
...
//******************************************************************************
// BuildKeyCPU (Rain coordinates, no orientation transform)
//******************************************************************************
int MTPianoKeyboardRoll11::_BuildKeyCPU(
