...
private:
	...
	//カラーテキストリスト：Ch.1-16, BG/GL/CT, Start/End（RGB 6桁16進）
	HWND m_hColorTextList[SM_MAX_CH_NUM + 3 + 2];

	//ced 20260628: アルファ入力リスト（0-255）：Ch.1-16, BG/GL/CT, Start/End
	...
	//ced 20260628: 1色分の表示更新（hex 欄=RGB6桁、アルファ欄=0-255）
	...
	//色テキスト欄(8桁RGBA)をパレットへ反映（透明度変更対応：ced 20260627）
