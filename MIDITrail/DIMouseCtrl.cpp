...
//DirectInput's DIMOFS_X/Y/Z are FIELD_OFFSET (macro-based offsetof) used as case
//labels; MSVC flags that as C4644. The macros are from dinput.h, so suppress it.
