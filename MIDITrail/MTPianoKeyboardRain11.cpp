...
//******************************************************************************
// Vertex buffer creation (Rain native coordinates)
//******************************************************************************
int MTPianoKeyboardRain11::_CreateVertexOfKeyboard(
		ID3D11Device* pDevice,
		ID3D11DeviceContext* pContext
	)
{
...
//******************************************************************************
// BuildKeyCPU (Rain: rotate in YZ plane, no model orientation transform)
//******************************************************************************
int MTPianoKeyboardRain11::_BuildKeyCPU(
